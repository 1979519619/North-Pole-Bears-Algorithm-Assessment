...
2.3 仍未全部完成：还需要学习 `.deb`、`apt` 和扩展的用途，实际验证 C/C++ 扩展功能，并整理一个以后能够稳定重复的 VSCode 构建与运行方式。
...
<!-- 记录实际使用的 Git 和 GitHub 资料及用途。 -->

## 学习与实施过程

<!-- 按日期记录初始化、提交、分支、合并、认证、推送和排错过程。 -->

## 结果

<!-- 直接给出提交历史、分支合并、远程链接、访问验证和指定命令证据。 -->
